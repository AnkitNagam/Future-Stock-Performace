...
if feat_select==1:
    ...
    if fs_type==1:
        ...
        if binning==1:
            rgr = DecisionTreeClassifier(criterion='gini', splitter='best', max_depth=None, min_samples_split=3, min_samples_leaf=1, max_features=None, random_state=rand_st)
    ...
    if fs_type==3:
        ...
        if binning==0:                                                              ######Only work if the Target is continuous###########
            #Univariate Feature Selection - Mutual Info Classification
    ...
    if fs_type==4:
        ...
        if binning==0:                                                              ######Only work if the Target is binned###########
            ...
            clf = DecisionTreeClassifier(criterion='gini', splitter='best', max_depth=None, min_samples_split=3, min_samples_leaf=1, max_features=None, random_state=rand_st)
                                #This could be any kind of classifier model
        ...
        if binning==1:                                                              ######Only work if the Target is continuous###########
            ...
            #Create Wrapper model
            rgr = DecisionTreeClassifier(criterion='gini', splitter='best', max_depth=None, min_samples_split=3, min_samples_leaf=1, max_features=None, random_state=rand_st)
                    #This could be any kind of regressor model         
...
if cross_val==0:    
    ...
    clf = DecisionTreeClassifier(criterion='entropy', splitter='best', max_depth=None, min_samples_split=175, min_samples_leaf=1, max_features=None, random_state=rand_st)
    clf.fit(data_train, target_train)

    scores_ACC = clf.score(data_test, target_test)
    print('without cross val')
